...
public class NamingController {
    ...
    public ResponseEntity<NodeResponse> getFileLocation(@PathVariable("filename") String filename) {
        ...
        return ResponseEntity.ok(new NodeResponse(targetNodeId, targetIp));
    }
